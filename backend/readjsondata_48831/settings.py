"""
Django settings for readjsondata_48831 project.
...
ROOT_URLCONF = "readjsondata_48831.urls"
...
WSGI_APPLICATION = "readjsondata_48831.wsgi.application"
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "ReadJsonData Support <support@readjsondata-48831.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "readjsondata_48831 API",
    "DESCRIPTION": "API documentation for readjsondata_48831 App",
    "VERSION": "v1",
}
